...
import SingleHolidayPage from "../components/app_components/HolidayPage/SingleHolidayPage";
import HolidayProjectLayoutPage from "../components/app_components/HolidayPage/HolidayProjectLayoutPage";
//  ~cb-add-import~
    ...
    return (
        <Routes>
            ...
            <Route path="/project" exact element={<DashboardAdminControl />} />
                ...
                // myapp
<Route path="/holiday/:singleHolidayId" exact element={<SingleHolidayPage />} />
<Route path="/holiday" exact element={<HolidayProjectLayoutPage />} />
