...
import seederData from "./holiday.seeder.json";
...
const HolidaySeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(HolidaySeederDialogComponent);
